...
$class = 'subpage lxfx';
$title = '立信分享';
$keywords = '立信分享,立信企管,企业管理';
$description = '立信分享-东莞立信企业管理';
  ...
  <div id="main">
    <div class="wrapper">
      <div class="w-fly-mr">
        <div class="w-fly-cnt">
          <div id="ajaxdata">
            <div class="w-cntbox lxfx">
              <div class="w-cntbox-hd">
                <h2 class="title">立信分享</h2>
            ...
            <div class="w-cntbox zsgl fn-hide">
              <div class="w-cntbox-hd">
      ...
      <aside class="w-fly-l">
        <div class="sidebar">
          <div id="js-menu" class="menu">
            ...
            <ul>
              <li class="on"><a href="#lxfx">立信分享</a></li>
              <li><a href="#zsgl">知识管理</a></li>
            </ul>
          </div>
          <div class="w-box">
            <div class="w-box-hd">
